...
| **Поиск источников** | Perplexity (осн.) / GPT (резерв) | Ищут заметно лучше Claude, отдают ссылки |
...
| Работа с длинными документами | Gemini | Огромное окно контекста — целая книга за раз |
