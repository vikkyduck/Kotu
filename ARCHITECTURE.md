...
| **Поиск и сбор информации** | **OpenAI (GPT)** | Ищет и собирает материал лучше остальных |
...
| **Написание лекции** | **Claude** | Длинный связный русский текст, выдержанный тон |
| **Генерация иллюстраций** | **Gemini** | Метафорические картинки в стиле гравюр |
| **Сборка презентации** | **Claude** | Получает готовые картинки от Gemini и исходный текст — раскладывает по слайдам, пишет тезисы и заметки докладчику |
