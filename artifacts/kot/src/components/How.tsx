  ...
  return (
    <section className="screen active" id="s-how">
      ...
      <div className="panel" style={{ marginTop: 'var(--sp-2)' }}>
        ...
        <div className="ex"><span className="ei"><Icon name="clock" /></span><div><b>Большие задачи идут в фоне</b><p>Лекции и презентации готовятся несколько часов — можно закрыть страницу.</p></div></div>
