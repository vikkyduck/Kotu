...
async function run(job: Job): Promise<void> {
  ...
  const system = [
    ...
    "— Слайдов в колоде НЕ БОЛЬШЕ 24. Длинную лекцию сжимай, объединяя близкие мысли, — а не отбрасывай хвост.",
    "",
  ...
  // 16000 было мало: раскадровка полной лекции (24 слайда с заметками
  // по-русски) обрывалась на потолке, и колода падала с ошибкой разбора.
  // Модель к тому же думает в счёт этого же лимита.
